...
var vm = new Vue({
  ...
  data: {
    smoothProducts: [
      {productNameJP: 'ノンリンス スムージング フルイド 100ml', productNameENG: 'smoothing fluid 100ml', imageSource: '../../image/individual/smoothing_fluid_100ml_F.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/36?salon_id=5'},
      {productNameJP: 'スムージング ヘアバス 240ml', productNameENG: 'smoothing hair bath 240ml', imageSource: '../../image/individual/smoothing_hair_bath_240ml_F.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/31?salon_id=5'},
      {productNameJP: 'スムージング　コンディショナー 240ml', productNameENG: 'smoothing conditioner 240ml', imageSource: '../../image/individual/smoothing_conditioner_240ml_F.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/33?salon_id=5'},
      {productNameJP: 'スムージング クリーム 150ml', productNameENG: 'smoothing cream 150ml', imageSource: '../../image/individual/smoothing_cream_150ml_F.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/35?salon_id=5'}
    ]
  }
});
...
var vm = new Vue({
  ...
  data: {
    mensItems: [
      {productNameJP: 'フェイス＆ビアード ハイドレイティング・クレンザー', productNameENG: 'face & beard hydrating cleanser', imageSource: '../../image/product_men/001_face-&-beard-hydrating-cleanser.png', ifingUrl: 'https://ifing-beauty.com/products/detail/109?salon_id=5'},
      {productNameJP: 'ソフニング・シェイビング・クリーム', productNameENG: 'softening shaving cream', imageSource: '../../image/product_men/002_softening-shave-cream.png', ifingUrl: 'https://ifing-beauty.com/products/detail/112?salon_id=5'},
      {productNameJP: 'アフターシェイビング・バーム', productNameENG: 'repairing aftershave balm', imageSource: '../../image/product_men/003_repairing-after-shave.png', ifingUrl: 'https://ifing-beauty.com/products/detail/113?salon_id=5'},
      {productNameJP: 'フェイス＆アイ エナジー・テクスチャー', productNameENG: 'face & eye energizing texture', imageSource: '../../image/product_men/006_face-&-eye-energizing-texture.png', ifingUrl: 'https://ifing-beauty.com/products/detail/110?salon_id=5'},
      {productNameJP: 'リップ・ビアード・サルブ', productNameENG: 'Lip & Beard Salve', imageSource: '../../image/product_men/009_lip-&-beard.png', ifingUrl: 'https://ifing-beauty.com/products/detail/114?salon_id=5'},
      {productNameJP: 'ヘア＆ボディ リフレッシング・ウォッシュ', productNameENG: 'hair & body invigorating wash', imageSource: '../../image/product_men/004_hair-and-body-invigorating-wash.png', ifingUrl: 'https://ifing-beauty.com/products/detail/111?salon_id=5'},
      {productNameJP: 'ウォーター・レジン', productNameENG: 'water resin', imageSource: '../../image/product_men/011_water-resin.png', ifingUrl: 'https://ifing-beauty.com/products/detail/105?salon_id=5'},
      {productNameJP: 'ロー・マッド', productNameENG: 'raw mud', imageSource: '../../image/product_men/008_raw-mud.png', ifingUrl: 'https://ifing-beauty.com/products/detail/106?salon_id=5'},
      {productNameJP: 'バンジー・ファイバー', productNameENG: 'bungee fiber', imageSource: '../../image/product_men/010_bungee-fiber.png', ifingUrl: 'https://ifing-beauty.com/products/detail/107?salon_id=5'},
      {productNameJP: 'ノクターナル・ヘア・レメディ', productNameENG: 'nocturnal hair remedy', imageSource: '../../image/product_men/005_nocturnal-hair-remedy.png', ifingUrl: 'https://ifing-beauty.com/products/detail/211?salon_id=5'},
      {productNameJP: 'シルバー・スティール・ヘアバス', productNameENG: 'silver steel hair bath', imageSource: '../../image/product_men/007_silver-steel-hair-bath.png', ifingUrl: 'https://ifing-beauty.com/products/detail/108?salon_id=5'},
    ]
  }
});
...
var vm = new Vue({
  ...
  data: {
    relifeItems: [
      ...
      {id: 2, productNameJP: 'スーシング・レメディ', productNameENG: 'soothing remedy', imageSource: '../../image/scalp/02-soothing_remedy.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/198?salon_id=5'},
...
var vm = new Vue({
  ...
  data: {
    products: [
      // life-style
      { id: 4, productNameJP: 'テルソ（240ml）', productNameENG: 'terso（240ml）', imageSource: '../../../image/dog/lifestyle007-terso.png', ifingUrl: 'https://ifing-beauty.com/products/detail/318?salon_id=5' },
      { id: 2, productNameJP: 'ネブラ（50ml）', productNameENG: 'nebula（50ml）', imageSource: '../../../image/dog/lifestyle005-nebula.png', ifingUrl: 'https://ifing-beauty.com/products/detail/317?salon_id=5' },
      { id: 1, productNameJP: 'ルジャーダ（50ml）', productNameENG: 'rugiada（50ml）', imageSource: '../../../image/dog/lifestyle004-rugiada.png', ifingUrl: 'https://ifing-beauty.com/products/detail/316?salon_id=5' },
      { id: 3, productNameJP: 'ブルーマ（100ml）', productNameENG: 'bruma（100ml）', imageSource: '../../../image/dog/lifestyle006-bruma.png', ifingUrl: 'https://ifing-beauty.com/products/detail/315?salon_id=5' },
...
var vm = new Vue({
  ...
  data: {
    products: [
      ...
      { id: 5, productNameJP: 'プロディジャスバーム（25ml）', productNameENG: 'Prodigious Balm 25ml', imageSource: '../../../image/dog/lifestyle008-prodigious-balm.png', ifingUrl: 'https://ifing-beauty.com/products/detail/319?salon_id=5' },
...
var vm = new Vue({
  ...
  data: {
    products: [
      { id: 6, productNameJP: 'レメディ ハンドバーム 50ml', productNameENG: 'Remedy Hand Balm 50ml', imageSource: '../../../image/dog/lifestyle003-remedy-hand-balm.png', ifingUrl: 'https://ifing-beauty.com/products/detail/306?salon_id=5' },
      { id: 7, productNameJP: 'ヴェルート (リップクリーム) 10ml', productNameENG: 'Velluto (Lip Cream) 10ml', imageSource: '../../../image/dog/lifestyle002-Velluto.png', ifingUrl: 'https://ifing-beauty.com/products/detail/307?salon_id=5' },
      { id: 9, productNameJP: 'テロ', productNameENG: 'Telo', imageSource: '../../../image/dog/lifestyle001-telo.png', ifingUrl: 'https://ifing-beauty.com/products/detail/308?salon_id=5' },
    ]
  }
});
...
var vm = new Vue({
  ...
  data: {
    products: [
      // dog
      { id: 8, productNameJP: 'デュエット 240ml', productNameENG: 'Duetto 240ml', imageSource: '../../../image/dog/Duetto-01.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/212?salon_id=5' },
    ]
  }
});
